function [SignalMap_dB,SignalMapdB] = CssmMethodHead(SignalMat,ArrayNumber,ArrayDistance,WaveLength,PreAngle)
%CSSMMETHODHEAD CSSM算法
    ...
    SignalTest = exp(1j*2*pi/0.03*(0:0.015:9*0.015)'*sin([PreAngle(1)]'));
    Alpha = randn(1, 1000);
    ReceiveTest = SignalTest*Alpha;    
    X1 = awgn(ReceiveTest, PreAngle(2));
    [~,MUSICMap]=MusicMethod(X1,10,0.015,0.03);
