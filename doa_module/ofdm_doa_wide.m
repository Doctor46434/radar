function [ArrivalAngle1,ArrivalAngle2]=ofdm_doa_wide(snr)
%% 参数 Parameters
ArrayNumber   = 12;               % 阵元数目
LightSpeed   = 3e8;              % 光速
...
[LCMVArrivalAngle,LcmvMap]=LcmvMethod(AllSignalMat(:,:),ArrayNumber,ArrayDistance,WaveLength(26));
[MUISCArrivalAngle,MusicMap]=MusicMethod(AllSignalMat(:,:),ArrayNumber,ArrayDistance,WaveLength(26));

ArrivalAngle1=LCMVArrivalAngle;
ArrivalAngle2=MUISCArrivalAngle;
